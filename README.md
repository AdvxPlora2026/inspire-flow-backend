...
│   └── routes/
├── core/            # Process configuration and shared infrastructure
├── data/            # Persistence boundary
│   ├── models/      # Future persistence entities
│   └── repositories/ # Future storage access implementations
...
behavior. Schemas own API contracts. The data layer is deliberately free of an
ORM until the application has a concrete persistence requirement.
